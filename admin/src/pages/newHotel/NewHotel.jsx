    ...
    try {
      const list = await Promise.all(
        Object.values(files).map(async (file) => {
          ...
          const uploadRes = await axios.post('https://api.cloudinary.com/v1_1/dw0nynnmv/image/upload', data);
          ...
          <div className="right">
            <form>
              <div className="formInput">
                ...
                <input type="file" multiple id="file" onChange={(e) => setFiles(e.target.files)} style={{ display: 'none' }} />
              </div>
